...
Remaining work includes multiple corpus sizes and deployment classes; Firefox,
WebKit, and low-end mobile measurements; browser-cache-warm modes; broader
lexical query classes; supported operating ranges and shard guidance; and CI
comparison without prematurely turning this baseline into a threshold.
