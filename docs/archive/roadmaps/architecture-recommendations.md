...
- Ranking framework ([23](./specification-roadmap.md) — no spec yet)
...
Specified in [../specs/query-planner.md](../specs/query-planner.md) (draft, not yet implemented) and decided at the architecture level in [ADR-0001](../../adr/0001-pull-based-static-http.md)'s transport model.

---

# 2. Explain API / internal performance instrumentation

Specified in [../specs/diagnostics.md](../specs/diagnostics.md) (draft, not yet implemented) — covers both the explain API and phase-timing instrumentation in one document rather than as two separate recommendations.

---

# 3. Make the pipeline pluggable

The plugin contract is decided in [../specs/plugin-architecture.md](../specs/plugin-architecture.md) (a fixed six-stage hook pipeline) and explored from a different angle in [../specs/plugin-api.md](../specs/plugin-api.md) — see that spec's own header for how the two relate. [ADR-0005](../../adr/0005-plugin-opt-in-boundary.md) records the core-vs-opt-in boundary decision already shipped. Not yet built: the dynamic registration mechanism itself.

---

# 4. Storage abstraction

Specified in [../specs/storage-api.md](../specs/storage-api.md) (draft, not yet implemented).

---

# 5. Binary/storage-format abstraction

Specified in [../specs/binary-format.md](../specs/binary-format.md) (draft spec; term/fuzzy/doc-store shards are already implemented and shipped, per that doc's own status note) and decided in [ADR-0002](../../adr/0002-json-first-index-format.md).
...
Performance discussions become objective once budgets exist. No spec or decision record covers this yet — the closest existing artifact is the bundle-size *code* budget (15 KB gzip, enforced in CI, [08-modern-features.md](../../concepts/architecture.md)), which is a narrower, already-shipped instance of the same idea for one specific resource.

---

# 7. Compression strategy

Specified in [../specs/binary-format.md](../specs/binary-format.md), which already covers delta-encoded ids and varints for the shipped binary tier; front-coded dictionaries and block compression remain future work within that same spec.
...
([../specs/benchmarking.md](../specs/benchmarking.md)), independent of whether
...
**Done**: [docs/02-index-format.md](../../concepts/index-format.md)
...
Covered by [../../project/governance.md](../../project/governance.md),
...
Specified in [../specs/benchmarking.md](../specs/benchmarking.md) (draft
...
authoritative one; [../../project/governance.md](../../project/governance.md)'s
...
Covered by [../specs/plugin-architecture.md](../specs/plugin-architecture.md) (the
decided registration/capability-negotiation contract) and
[../specs/plugin-api.md](../specs/plugin-api.md) (a draft exploring the same
...
ranking framework in [./specification-roadmap.md](./specification-roadmap.md))
