...
Phases 3, 4, and 5 are partially built — [`packages/analysis`](packages/analysis)
...
pnpm test:browser             # 19 Playwright tests in real Chromium (Worker execution, lifecycle, showcase, feature gallery)
