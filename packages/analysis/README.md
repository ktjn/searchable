...
Shared text-analysis pipeline for Searchable. The indexer and browser runtime
use the same tokenization, segmentation, stemming, and language-profile
primitives so index-time and query-time analysis stay aligned.
