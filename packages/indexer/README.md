# `@ktjn/searchable-indexer`

Reference TypeScript indexer for Searchable. It extracts searchable fields from
rendered HTML and writes a static manifest plus content-addressed shards. The
package also provides the planned `searchable-indexer` command-line entry point.
